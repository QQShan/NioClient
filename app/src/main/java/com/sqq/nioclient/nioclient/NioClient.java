package com.sqq.nioclient.nioclient;

import android.util.Log;

import com.sqq.nioclient.rxbus.DisConnectedEvent;
import com.sqq.nioclient.rxbus.GetResponseEvent;
import com.sqq.nioclient.rxbus.RxBus;
...
public class NioClient implements Runnable {
    ...
    public boolean send(String message) {
        if (poolManager.getConnection() == null||clientClosed) {
            //没有可用的连接,提示检测网络
            return false;
        }
        Log.d(TAG, message);
